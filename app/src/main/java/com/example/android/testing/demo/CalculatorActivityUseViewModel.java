 ...
 */
public class CalculatorActivityUseViewModel extends AppCompatActivity {

    private static final String TAG = "CalculatorActivity";

    private CalculatorViewModel mCalculatorViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCalculatorViewModel = ViewModelProviders.of(this).get(CalculatorViewModel.class);
        ...
        mCalculatorViewModel.calculatorResultLiveData.observe(this, new Observer<String>() {
            @Override
    ...
    private void compute(Calculator.Operator operator) {
        ...
        mCalculatorViewModel.calc(operandOne, operandTwo, operator);
    }
